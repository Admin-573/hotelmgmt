...
<body>
    ...
    <table cellspacing="18px">
        <tr>
            <td class=box>
                <div>
                    <img src="images/hotel.jpg" width="350px" style="border-radius:12px  ; margin-bottom:12px ; margin-left:25px"/>
                </div>
                <div>
                    <fieldset style="border-radius:4px ; margin-left:32px; margin-right:32px; margin-bottom:32px ; border-color:Black ; border-width:4px ; text-align:center ;">
                        ...
                        Room ID
                        <asp:TextBox ID="rid" runat="server" CssClass=text_des style="margin-left:72px" Disabled=disabled></asp:TextBox>

                        </br>

                        Update Room Type
                        <asp:DropDownList ID="upd_rtype" runat="server" CssClass=select_des style="margin-left:12px">
                        ...
                        Update Room Fee
                        <asp:TextBox ID="upd_rfee" runat="server" CssClass=text_des style="margin-left:22px ; margin-right:4px"></asp:TextBox>
            ...
            <td class=box>
                <div>
                    <fieldset style="border-radius:4px ;  margin-left:32px; margin-right:32px; margin-bottom:32px ; margin-top:32px ; border-color:Black ; border-width:4px ; text-align:center">
                        ...
                        Emp-ID
                        <asp:TextBox ID="eid" runat="server" CssClass=text_des style="margin-left:56px" Disabled=disabled></asp:TextBox>
                        ...
                        Update Emp Role
                        <asp:DropDownList ID="empDes" runat="server" CssClass=select_des style="margin-left:14px">
